                ...
                <section>        			
        			<div id="password" class="formSection">
        				<ul class="logiForm">
        				    ...
        				    <li><input id="pass_code" type="number" placeholder="请输入验证码"><button id="btn_pass_captcha" class="btn btn-sm btn-primary">获取验证码</button></li>
        				    <li><input id="pass_password" type="password" placeholder="请输入密码"></li>
        				    <li><input id="pass_repass" type="password" placeholder="请重复密码"></li>
        				</ul>
        				<button id="btn_password" class="btn btn-block btn-orange">确认修改</button>
        			</div>
        		</section>
            </div>
        </div>
...
$(function() {
	...
	$('#btn_password').click(function() {
		var pass_code = $('#pass_code').val(),
	        pass_password = $('#pass_password').val(),
	        pass_repass = $('#pass_repass').val();
        var pass_data = { 'code':pass_code, 'password':pass_password };
